...
const YO_PLAIN_TO_YO: Record<string, string> = {
  ...
  озеро: "озеро",
  затмение: "затмение",
  // Свекла — не омограф, но без «ё» RUAccent читал «свЕкла» с ударением на
  // первом слоге; с «ё» ошибка невозможна (ё всегда ударная). RUAccent эту
  // ёфикацию не делает, а словарь здесь — делает.
  свекла: "свёкла",
};
